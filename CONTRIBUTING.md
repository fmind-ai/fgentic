...
1. **G3 — trust proof:** the external security report in #459 is published; the M15 retention (#137), moderation (#136), and accepted audit-retention ADR (#302) controls are complete; the M11 sovereignty kit (#88), including the legally/DPO-approved compliance annex in #74, is complete; and #86 links live reference-deployment evidence. Prepared source, an unaccepted ADR, or offline renders do not count as publication, accepted policy, or live proof.
