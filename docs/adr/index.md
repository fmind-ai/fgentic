...
- [0020 — Partner Trust Registry Trust-Domain Model](0020-partner-trust-registry-domain-model.md) - directional trust graph with local-identity separation and room-instance reconciliation, Proposed (M29)
