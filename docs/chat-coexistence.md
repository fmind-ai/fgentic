...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mattermost       | Mattermost's official Apache-2.0 [`mattermost-plugin-matrix-bridge`](https://github.com/mattermost/mattermost-plugin-matrix-bridge) publishes `v0.1.12` and documents bidirectional messages, reactions, edits, files, threads, and user attribution. It requires Mattermost 10.7.1+ with a Pro, Enterprise, or higher license; private and encrypted channel support remains on its roadmap. Community bridgev2 and pre-release alternatives also exist. | This is a credible vendor-owned qualification path, not a Fgentic-shipped or tested unit. Confirm the paid-edition boundary and every semantic, security, scale, upgrade, and offboarding criterion above against the deployed versions. |
