...
ESS 26.6.2 already exposes MAS's `adminapi` resource on the public MAS listener. Do not add a second listener or override the chart-owned `http.listeners` configuration.
