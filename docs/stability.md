...
| A2A extension URIs for quotes, receipts, mandate profiles                                                   | Experimental | Remain Experimental | #142, #141, #144                                                                                | The owning surfaces are incomplete or vision-scoped; reserving versioned names does not promise shipped behavior.       |
