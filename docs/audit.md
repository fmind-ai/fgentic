...
| agentgateway request logs    | JSON stdout only; `infra/agentgateway/base/parameters.yaml` configures format/level but no durable logging database or export.                                                                                                                                                                                                                                                                                                                  | Configure an approved log export and its own retention. Keep prompt/completion logging disabled unless separately authorized.                                                                                                                                                                                       |
