...
- Gateway API v1.4.0 **experimental**, Traefik chart 39.x, and agentgateway v1.3.1 currently preserve the served TCPRoute/API compatibility used by the platform. Review and move them together.
