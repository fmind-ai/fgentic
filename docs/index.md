...
- [Sovereign Agent Platform Reference Architecture](reference-architecture.md) - vendor-neutral requirements matrix, architecture views, evidence boundaries, and copy-ready RFP checklist
